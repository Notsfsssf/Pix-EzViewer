...
switch1.isChecked=!sharedPreferencesServices!!.getBoolean("disablecrash")
        ...
        spinner_chushi.setSelection(PreferenceManager.getDefaultSharedPreferences(PxEZApp.instance).getString("firstpage", "0")?.toInt()?:0, true)
    ...
    fun checkforupdate(v: View) {
        try {
            ...
            Toasty.info(this, "no browser found", Toast.LENGTH_SHORT).show()
        }
    }
