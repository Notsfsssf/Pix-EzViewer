...
interface AppApiPixivService {
    ...
    @get:GET("v1/walkthrough/illusts")
    val walkthroughIllusts: Observable<WalkthroughResponse>
    ...
    fun getIllustBrowsingHistory(@Header("Authorization") paramString: String): Observable<UserIllustsResponse>

    @GET("/v1/user/bookmarks/illust")
    fun getLikeIllust(@Header("Authorization") paramString1: String, @Query("user_id") paramLong: Long, @Query("restrict") paramString2: String, @Query("tag") paramString3: String?): Observable<UserIllustsResponse>
    ...
    fun getNewTab(@Header("Authorization") Authorization: String): Call<FollowResponse>
    ...
    @GET
    fun getNextHistory(@Header("Authorization") Authorization: String, @Url paramString2: String): Observable<UserIllustsResponse>

    @GET("/v1/illust/related?filter=for_ios")
    fun getAboutPicture(@Query("illust_id") id: Int): Observable<AboutPictureResponse>

    @GET("/v1/illust/ranking?filter=for_ios")
    fun getIllustRanking(@Header("Authorization") paramString1: String, @Query("mode") paramString2: String, @Query("date") paramString3: String?): Observable<IllustRankingResponse>
    ...
    fun getFollowIllusts(@Header("Authorization") paramString1: String, @Query("restrict") paramString2: String): Observable<IllustfollowResponse>
    ...
    fun getUserIllusts(@Header("Authorization") paramString1: String, @Query("user_id") paramLong: Long, @Query("type") paramString2: String): Observable<UserIllustsResponse>

    @GET("/v1/user/illusts?filter=for_ios")
    suspend fun getUserIllustsCor(@Header("Authorization") paramString1: String, @Query("user_id") paramLong: Long, @Query("type") paramString2: String): UserIllustsResponse

    @GET
    fun getNextUserIllusts(@Header("Authorization") paramString1: String, @Url paramString2: String): Observable<UserIllustsResponse>

    @GET
    suspend fun getNextUserIllustsCor(@Header("Authorization") paramString1: String, @Url paramString2: String): UserIllustsResponse

    @GET
    fun getNextUserIllustsBlock(@Header("Authorization") paramString1: String, @Url paramString2: String): Call<UserIllustsResponse>
